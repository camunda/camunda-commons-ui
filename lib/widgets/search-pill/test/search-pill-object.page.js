...
Pill.prototype.typeField = function() {
  return new InlineField(this.node.element(by.css('[cam-widget-inline-field][value="type.value"]')));
};
Pill.prototype.nameField = function() {
  return new InlineField(this.node.element(by.css('[cam-widget-inline-field][value="name.value"]')));
};
Pill.prototype.operatorField = function() {
  return new InlineField(this.node.element(by.css('[cam-widget-inline-field][value="operator.value"]')));
};
Pill.prototype.valueField = function() {
  return new InlineField(this.node.element(by.css('[cam-widget-inline-field][value="value.value"]')));
};
