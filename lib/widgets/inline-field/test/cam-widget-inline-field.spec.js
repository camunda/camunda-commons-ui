...
describe('Inline Edit Field', function() {
  ...
  beforeEach(function(){
    browser.get('http://localhost:' + pkg.gruntConfig.connectPort + '/lib/widgets/inline-field/test/cam-widget-inline-field.spec.html');
  });
...
describe('Text Input', function() {
  ...
  it('should cancel the edit of value on click on cancel', function() {
    element(by.id('field1')).getText().then(function(textBefore) {
      ...
      expect(element(by.tagName('input')).getAttribute('value')).toEqual(textBefore + text);
