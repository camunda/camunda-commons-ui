          ...
          if(!scope.editing) {
            ...
            $timeout(function() {
              $timeout(function() {
                ...
                if (savedEditValue && savedEditValue.value) {
                  angular.element(element[0].querySelector('[ng-model="editValue"]'))
                    .val(typeof(savedEditValue) === String ? savedEditValue : savedEditValue.value);
                }
            ...
            $timeout(function() {
              angular.element(element[0].querySelector('[ng-model="editValue"]')).triggerHandler('click');
