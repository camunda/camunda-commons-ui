              ...
              $timeout(function() {
                ...
                if(savedEditValue) {
                  ...
                  if (isValueOfTypeObject) {
                    angular.element(element[0].querySelector('[ng-model="editValue"]')).val(savedEditValue.value);
                  }

                  $timeout(function() {
                    var elems = $(element[0].querySelector('li[ng-mouseenter]'));
                    var compareValue = isValueOfTypeObject ? savedEditValue.value : savedEditValue;
