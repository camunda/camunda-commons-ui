...
var angular = require('camunda-bpm-sdk-js/vendor/angular'),
    ...
    confirmationTemplate = fs.readFileSync(__dirname + '/cam-widget-variables-deletion-dialog.html', 'utf8');
      ...
      link: function($scope) {
        ...
        $scope.deleteVariable = function(v) {
          ...
          $modal.open({	
            controller: ['$scope',	
              function($scope) {	
                $scope.body = $translate.instant('CAM_WIDGET_VARIABLES_TABLE_DIALOGUE', {'name': info.variable.name});	
