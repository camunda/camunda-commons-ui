...
describe('Variables Table', function() {
  ...
  describe('editing', function() {
    ...
    describe('Date variable', function() {
      ...
      it('has a value input', function() {
        expect(variable.valueValue()).to.eventually.eql('2015-03-23T13:14:06.340+0200');
      });
      ...
      describe('default value', function() {
        ...
        after(function() {
          variable.valueInput().clear().sendKeys('2015-03-23T13:14:06.340+0200');
        });
  ...
  describe('cam-headers attribute', function() {
    ...
    it('can be used to display the wanted columns', function() {
      ...
      expect(headers.count()).to.eventually.eql(7);
