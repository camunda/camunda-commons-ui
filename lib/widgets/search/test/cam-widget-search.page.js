...
Example.prototype.inputDropdown = function() {
  return this.node.element(by.css('[cam-widget-search] .search-container > ul'));
};

Example.prototype.inputDropdownOption = function(option) {
  return this.node.all(by.css('[cam-widget-search] .search-container > ul > li')).get(option);
};

Example.prototype.inputDropdownOptionCount = function() {
  return this.node.all(by.css('[cam-widget-search] .search-container > ul > li')).count();
};
