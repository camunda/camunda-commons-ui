  ...
  function($timeout,   $location,   searchService, widgetLocalConf) {
    ...
    return {
      ...
      scope: {
        ...
        disableTypeaheadAutoselect: '=?camWidgetSearchDisableTypeaheadAutoselect'
      },
      ...
      link: function($scope, element) {
        ...
        var handleSearchesUpdate = function() {
          ...
          if ($scope.isVariableCaseHandlingActive) {
            ...
            $scope.variableCaseHandling = options[!!$scope.caseHandeling.ignoreNames + !!$scope.caseHandeling.ignoreValues * 2];
            queryObj.variableCaseHandling = $scope.variableCaseHandling;
          }
        ...
        $scope.$watch('[searches, matchAny, caseHandeling]', handleSearchesUpdate, true);
        ...
        $scope.loadCriteriaSet = function($evt, name, group) {
          ...
          if ($scope.isVariableCaseHandlingActive) {
            if (original[original.length - 1]['caseHandeling']) {
              $scope.caseHandeling =
                original[original.length - 1]['caseHandeling'];
            } else {
              $scope.caseHandeling = {
                ignoreNames: true,
                ignoreValues: true
