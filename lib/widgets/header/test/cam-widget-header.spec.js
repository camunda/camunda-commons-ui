...
describe('Header', function() {
  ...
  describe('Anonymous - no app switch', function() {
    before(function() {
      browser.get(pageUrl + '#anonymous-no-app-switch');
      header = page.header('#anonymous-no-app-switch');
    });

    it('hides the application switch', function() {
  ...
  describe('Authenticated - no app switch', function() {
    before(function() {
      browser.get(pageUrl + '#authenticated-no-app-switch');
      header = page.header('#authenticated-no-app-switch');
    });
