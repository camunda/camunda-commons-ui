...
Header.prototype.adminLink = function() {
  return this.node.element(by.css('.app-menu .app-switch .admin'));
};
Header.prototype.cockpitLink = function() {
  return this.node.element(by.css('.app-menu .app-switch .cockpit'));
};
Header.prototype.tasklistLink = function() {
  return this.node.element(by.css('.app-menu .app-switch .tasklist'));
};
