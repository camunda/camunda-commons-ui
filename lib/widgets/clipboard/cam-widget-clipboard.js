  ...
  return {
    ...
    link: function($scope, element, attrs) {
      ...
      function handleResize() {
        ...
        var contentWidth = (content.offsetWidth + icon.offsetWidth);
        var containerWidth = parseInt(elementStyle.width) - parseInt(elementStyle.paddingRight) - parseInt(elementStyle.paddingLeft);
