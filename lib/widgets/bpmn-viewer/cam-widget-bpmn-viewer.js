...
module.exports = ['$q', '$document', '$compile', '$location', '$rootScope', 'search', 'debounce', 'widgetLocalConf',
  function($q, $document, $compile,   $location,   $rootScope,   search, debounce, widgetLocalConf) {
    ...
    return {
      ...
      link: function($scope, $element) {
        ...
        function attachDiagram() {
          diagramContainer.appendChild(viewer.container);
        }

        function detatchDiagram() {
          diagramContainer.removeChild(viewer.container);
        }
