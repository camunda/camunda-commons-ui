  ...
  function($compile,   $location,   $rootScope,   search, debounce) {
    ...
    return {
      ...
      link: function($scope, $element) {
        ...
        // CRAZY HAXX
        // Basically, this is the logic diagram-js does to defer its update of the viewbox change
        ...
        // like they are "dragged behind".
        viewer.get('canvas')._viewboxChanged = debounce(viewer.get('canvas')._viewboxChanged, 0);

        // if you don't like dragging behind and prefer flickering for the badges, remove this line:
        window.setTimeout(function(){viewer.get('overlays').hide = function(){};},200);
