...
var angular = require('camunda-bpm-sdk-js/vendor/angular'),
    ...
    commonsUtil = require('../util/index'),
...
ngModule
  ...
  .run([
    '$rootScope', 'Notifications', 'shouldDisplayAuthenticationError',
    function($rootScope, Notifications, shouldDisplayAuthenticationError) {
