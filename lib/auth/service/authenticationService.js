...
/**
   ...
   */
module.exports = [  '$rootScope', '$q', '$http', 'Uri', '$route',
  function($rootScope,   $q,   $http,   Uri, $route) {
    ...
    this.login = function(username, password) {
      ...
      function success(authentication) {
        ...
        $http.get(Uri.appUri('./csrf-token.html')).then(function() {
    ...
    this.logout = function(engine) {
      ...
      return $http.post(Uri.appUri('admin://auth/user/' + (engine || ':engine') + '/logout')).then(success, error);
    };
