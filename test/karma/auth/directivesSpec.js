define([ 'chai', 'angular', 'angular-route', 'lib/auth/index' ], function(chai, angular, ngRoute, authModule) {
  'use strict';
  ...
  return describe('camunda-commons-ui/auth/directives', function() {

    beforeEach(module(authModule.name));
